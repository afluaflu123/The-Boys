class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</a>, A Sᴍᴀʀᴛ Rᴏʙᴏᴛ Wɪᴛʜ Mᴀɴʏ Aᴍᴀᴢɪɴɢ Fᴇᴀᴛᴜʀᴇs. I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs & Hᴇʟᴘ Yᴏᴜ Tᴏ Mᴀɴᴀɢᴇ Yᴏᴜʀ Gʀᴏᴜᴘs, Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ Aɴᴅ Eɴᴊᴏʏ. 😈</b>."""
...
✯ Bᴜʟʟᴅ Sᴛᴀᴛᴜs: <code>ᴠ2.7.1 [ Bᴇᴛᴀ ].</code></b>"""
...
• /connections - <code>ʟɪꜱᴛ ᴀʟʟ ʏᴏᴜʀ ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ</code>"""
    ...
    APPROVE_TXT = """Hᴇʟᴘ: Exᴛʀᴀ Mᴏᴅᴜʟᴇs
<b>ɴᴏᴛᴇ:</b>
...
• /search  - <code>ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴍ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ꜰʀᴏᴍ ᴠᴀʀɪᴏᴜꜱ ꜱᴏᴜʀᴄᴇꜱ.</code>"""
    ...
    EXTRAMODS_TXT = """<b>Cʟɪᴄᴋ Oɴ Tʜᴇ Bᴜᴛᴛᴏɴꜱ Bᴇʟᴏᴡ Tᴏ Gᴇᴛ Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ Aʙᴏᴜᴛ Sᴘᴇᴄɪꜰɪᴄ Mᴏᴅᴜʟᴇꜱ..</b>"""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : • HᴀᴄKᴇʀ Jʀ ~ 🕊 •
• ᴜꜱᴇʀɴᴀᴍᴇ : @Hacker_Jr
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/Hacker_Jr'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
